...
import com.aqsystem.aqsystem.service.NetReceiver;
...
public class SysUtil {
	...
	public static int[] getScreenDispaly() {
		WindowManager windowManager = (WindowManager) BLApplcation
	...
	public static long getFreeMemory() {
		ActivityManager am = (ActivityManager) BLApplcation.getApplication()
	...
	public static void getXgStrongth() {
		NetReceiver.NetState state = NetReceiver.isConnected(BLApplcation.getApplication());
	...
	public static String getCachePath() {
		Context context = BLApplcation.getApplication()
	...
	public static Toast makeText(String text) {
		return makeText(BLApplcation.getApplication(), text, Toast.LENGTH_SHORT);
	}
	...
	public static Toast makeText(Context context, String text, int duration) {
		if(mToast != null){
			...
			ShapeDrawable drawable = ViewUtil.createRoundCornerShapeDrawable(40, 0, "#000000");
